...
@pytest.mark.skipif(
    sys.platform == "win32" and not util.windows_has_tzdata(),
...
@pytest.mark.parametrize(
    ("ty", "scalar_typ"),
    [(pa.string(), pa.StringScalar), (pa.large_string(), pa.LargeStringScalar)],
)
...
@pytest.mark.parametrize(
    ("ty", "scalar_typ"),
    [(pa.binary(), pa.BinaryScalar), (pa.large_binary(), pa.LargeBinaryScalar)],
)
