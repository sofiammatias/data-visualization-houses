...
def _roundtrip_table(
    table, read_table_kwargs=None, write_table_kwargs=None, use_legacy_dataset=False
):
    ...
    return _read_table(
        reader, use_legacy_dataset=use_legacy_dataset, **read_table_kwargs
    )
...
def _roundtrip_pandas_dataframe(df, write_kwargs, use_legacy_dataset=False):
    ...
    result = _roundtrip_table(
        table, write_table_kwargs=write_kwargs, use_legacy_dataset=use_legacy_dataset
    )
