...
class WidgetStates(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["widgets", b"widgets"]
    ) -> None: ...
...
class WidgetState(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        bytes_value: builtins.bytes = ...,
        file_uploader_state_value: streamlit.proto.Common_pb2.FileUploaderState
        | None = ...,
        string_trigger_value: streamlit.proto.Common_pb2.StringTriggerValue
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
