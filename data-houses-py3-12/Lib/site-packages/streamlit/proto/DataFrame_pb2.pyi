...
class MultiIndex(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        labels: collections.abc.Iterable[streamlit.proto.Common_pb2.Int32Array]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["labels", b"labels", "levels", b"levels"],
    ) -> None: ...
...
class CSSStyle(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "property", b"property", "value", b"value"
        ],
    ) -> None: ...
...
class CellStyleArray(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["styles", b"styles"]
    ) -> None: ...
...
class AnyArray(google.protobuf.message.Message):
    ...
    def WhichOneof(
        ...
        typing_extensions.Literal[
            "strings", "doubles", "int64s", "datetimes", "timedeltas"
        ]
        | None
    ): ...
...
class Table(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["cols", b"cols"]
    ) -> None: ...
