...
class MetricSet(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["metric_families", b"metric_families"],
    ) -> None: ...
...
class UnknownValue(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["value", b"value"]
    ) -> typing_extensions.Literal["double_value", "int_value"] | None: ...
...
class CounterValue(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["total", b"total"]
    ) -> typing_extensions.Literal["double_value", "int_value"] | None: ...
...
class HistogramValue(google.protobuf.message.Message):
    ...
    class Bucket(google.protobuf.message.Message):
        ...
        def HasField(
            self, field_name: typing_extensions.Literal["exemplar", b"exemplar"]
        ) -> builtins.bool: ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal[
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["sum", b"sum"]
    ) -> typing_extensions.Literal["double_value", "int_value"] | None: ...
...
class StateSetValue(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["states", b"states"]
    ) -> None: ...
