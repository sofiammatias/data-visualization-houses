...
class TimeInput(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        set_value: builtins.bool = ...,
        disabled: builtins.bool = ...,
        label_visibility: streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage
        | None = ...,
        step: builtins.int = ...,
    ) -> None: ...
    def HasField(
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_default", b"_default"]
    ) -> typing_extensions.Literal["default"] | None: ...
    @typing.overload
    def WhichOneof(
