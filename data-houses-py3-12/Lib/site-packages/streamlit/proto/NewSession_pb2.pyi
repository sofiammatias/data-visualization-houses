...
class NewSession(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        app_pages: collections.abc.Iterable[streamlit.proto.AppPage_pb2.AppPage]
        | None = ...,
        page_script_hash: builtins.str = ...,
    ) -> None: ...
    def HasField(
...
class CustomThemeConfig(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "font_sizes", b"font_sizes", "radii", b"radii"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class FontFace(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "family", b"family", "style", b"style", "url", b"url", "weight", b"weight"
        ],
    ) -> None: ...
